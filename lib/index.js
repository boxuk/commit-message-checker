...
module.exports = {
    ...
    getCommitMessagesFromSHAs: gitHelper.getCommitMessagesFromSHAs,

    getCommitMessagesFromSHARange: gitHelper.getCommitMessagesFromSHARange,

    getCommitMessageFromSHA: gitHelper.getCommitMessageFromSHA
};
